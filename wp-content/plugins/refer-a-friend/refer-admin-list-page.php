...
class TT_Example_List_Table extends WP_List_Table {
 ...
 function __construct(){
    ...
    function column_to_name($item){
        ...
        //Build row actions
        $actions = array(
            'edit'      => sprintf('<a href="?page=%s&action=%s&id=%s">Edit</a>','refer-admin-edit.php','edit',$item['ID']),
    ...
    function prepare_items($search ='') {
        ...
        function usort_reorder($a,$b){
            $orderby = (!empty($_REQUEST['orderby'])) ? $_REQUEST['orderby'] : 'to_name'; //If no sort, default to title
