 ...
 * Template Name:new tourschedule
			...
			<div class="ts_state_data">
				...
				<div class="container">
					...
					<div class="ts_data_list add-line">
						...
						<div class="ts_data_list_item no-found">

							<img src="<?php echo get_template_directory_uri(); ?>/images/calendarIcon.svg" alt="icon">

							<h2>No schedule found <br>for <b>State</b></h2>
...
<!-- <div class="popup_overlay2" style="display:none !important;">
