...
//     the_cfc_field( 'my_meta_name','first-name', false, $key );
// }
?>
            ...
            <div class="mainBanner selected <?php the_cfc_field( 'main_slider','light-text', false, $key );?>  <?php the_cfc_field( 'main_slider','aligned', false, $key );?>" style="background-image: url('<?php echo the_cfc_field( 'main_slider','image', false, $key );?>')">
                <div class="container">
                    <div class="bannerContent">
                        ...
                        <p><a href="<?php echo the_cfc_field( 'main_slider','button-link', false, $key );?>" class="fittedBtn"><?php echo the_cfc_field( 'main_slider','button-text', false, $key );?></a></p>
                    </div>
                </div>
            </div>
        </div>
...
<div class="homeTagLine commonSection">
    <h3>Specialists in handcrafted custom clothing</h3><p>A fully handmade custom garment designed and commissioned by you, and created specifically just for you. 
    </p>
</div>
<div class="ho_pe_ex">
    <div class="container">
        ...
        <div class="ho_cu_de">
            ...
            <div class="designShirt designBox">
                ...
                <p><a href="<?php echo esc_url(home_url());?>/tour-schedule" class="startBtn">Start Now <i class="fa fa-chevron-right"></i></a></p>
            </div>
        </div>
    </div>
</div>
<div class="ho_HIT clearfix">
    <div class="ho_HIT_left">
        <h4>How it<br>
            works</h4>
        <p>Meet with a traveling tailor in your city to be fitted for your next custom suit/shirt. Locate a tailor by viewing our <a href="<?php echo site_url();?>/tour-schedule">tour schedule.</a></p>
    </div>
    <div class="ho_HIT_right">
        <ul class="unstyled-list">
            <li>
                ...
                <a class="unstyled-anchor" href="<?php echo site_url();?>/tour-schedule">Tell me more</a>
            </li>
            <li>
            ...
            <li>
                ...
                <figcaption>Handmade Bespoke Construction</figcaption>
                <a class="unstyled-anchor" href="<?php echo site_url();?>/custom-experience">Tell me more</a>
...
<div class="homeBlock clearfix">
    <div class="HB_visit">
        ...
        <p><a href="<?php echo site_url();?>/tour-schedule/#cityMap" class="btnBig">Don't see your city above? See our FULL road tour <i class="fa fa-chevron-right"></i></a></p>
    </div>
    <div class="HB_refer">
...
<div class="testimonials_home">
    ...
    <a href="<?php echo site_url();?>/testimonial/" class="fitted_btn">Read More</a>
