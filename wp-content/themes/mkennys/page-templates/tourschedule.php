...
$states = $wpdb->get_results($state_sql);
	foreach($states as $state){
	 $stateHtml .='<option '.$selected.' value="'.$state->id.'" data-id="'.$state->state_name.'">'.$state->state_name.'</option>';
	}
return $stateHtml;
...
<div class="">
    <div class="tourSchedule">
		...
		<?php echo do_shortcode( '[tourSchedule stateId='.$byLocation_stateId.' allstate=1]' ) ; ?>
		</div>
    </div>
</div>
            ...
            <div class="grid-12">
                ...
                <form class="app_form_validation" id="app_form_validation">
                    ...
                    <div><img src="<?php echo get_template_directory_uri(); ?>/mathcaptcha/captcha.php" id="captcha_image"> <br>
                        ...
                        <label for='message'>Enter the code above here 123 :</label>
                        <br>
